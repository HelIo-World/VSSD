...
model = dict(
    ...
    decode_head=dict(in_channels=[64, 128, 256, 512], num_classes=9,act_cfg=dict(type='ReLU', inplace=False)),
    auxiliary_head=dict(in_channels=256, num_classes=9,act_cfg=dict(type='ReLU', inplace=False),)
)
